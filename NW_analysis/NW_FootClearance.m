...
save_folder = 'C:\abe_backup\backup\01_修士\06_Xsens_analysis\07_clinical-analysis\FootClearance';
...
% for p_idx = 1:length(nw_paths)
    ...
    for j = 1:length(current_nw_contact_frame)-1
        ...
        foot_min = min(current_nw_data.(target_joint).(target_axis));
        current_cycle = current_cycle - foot_min;
