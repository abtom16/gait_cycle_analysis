...
save_folder = 'C:\abe_backup\backup\01_修士\06_Xsens_analysis\08_ASvsNW\Toe_z\youth_vs_expert';
...
for p_idx = iteration_setup
    ...
    if strcmpi(target_foot, 'Left')
        ...
        current_youth_data_toe_z = current_youth_data.LToe.z;
        current_expert_data_toe_z = current_expert_data.LToe.z;
        ...
        current_youth_data_toe_z = current_youth_data.RToe.z;
        current_expert_data_toe_z = current_expert_data.RToe.z;
    end

    for j = 1:length(current_youth_contact_frame)-1
        current_cycle = current_youth_data_toe_z( ...  %
    ...
    for j = 1:length(current_expert_contact_frame)-1
        current_cycle = current_expert_data_toe_z( ...  %
    ...
    if strcmp(target_foot, 'Left')
        ...
        save_filename = ['sub15','_Toe_z-youthvsexpert.png'];
    end
